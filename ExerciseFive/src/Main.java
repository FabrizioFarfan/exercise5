public class Main {
    ...
    /**
     * 3: Use Modulus (%) to calculate the remaining amount of money if
     * we buy as many burgers as possible, print remainder
     */
